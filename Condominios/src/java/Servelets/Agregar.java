...
public class Agregar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuarioRepetido == true) {
            out.println("alert('Dueno" + txtCedula + "  registrado  anteriormente')");
            out.println("location= 'index.jsp'");

        } else {

            boolean registro = metodo.registrar(txtCedula,txtNombre,txtApe1,txtApe2,txtTelefono,txtEmail,txtTipo);
            if (registro == true) {
                out.println("alert('Dueno registrado en forma exitosa')");
                out.println("location= 'index.jsp'");
            } else {
...
/*
boolean registro = metodo.registrar(txtCedula,txtNombre,txtApe1,txtApe2,txtTelefono,txtEmail);
