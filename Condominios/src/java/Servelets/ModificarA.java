    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String txtCedula= request.getParameter("cedula");
        ...
        if (usuarioRepetido == true) {
           boolean registro = metodo.modificarAccesos(txtCedula, txtNombre, txtApe1, txtApe2, txtNum_casa, txtDescripcion, txtHora);
            if (registro == true) {
                out.println("alert('Acceso Modificado en forma exitosa')");
                out.println("location= 'index.jsp'");
            }else {
                out.println("alert('Error: Acceso no Modificado')");
                out.println("location= 'index.jsp'");
            }
